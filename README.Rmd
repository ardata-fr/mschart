...
[![test coverage](https://codecov.io/gh/ardata-fr/mschart/branch/master/graph/badge.svg)](https://app.codecov.io/gh/ardata-fr/mschart)
...
`ms_barchart()`, `ms_linechart()`, `ms_areachart()`, `ms_scatterchart()`,
`ms_piechart()`, `ms_bubblechart()`, `ms_radarchart()`, `ms_stockchart()`.
