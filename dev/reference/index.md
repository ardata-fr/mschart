...
- [`mschart-package`](https://ardata-fr.github.io/mschart/dev/reference/mschart.md)
  [`mschart`](https://ardata-fr.github.io/mschart/dev/reference/mschart.md)
  : Chart Generation for 'Microsoft Word', 'Microsoft Excel' and
...
- [`chart_settings()`](https://ardata-fr.github.io/mschart/dev/reference/chart_settings.md)
  : Set chart options
- [`as_bar_stack()`](https://ardata-fr.github.io/mschart/dev/reference/as_bar_stack.md)
...
- [`chart_table()`](https://ardata-fr.github.io/mschart/dev/reference/chart_table.md)
  : Data table settings
- [`chart_fill_ggplot2()`](https://ardata-fr.github.io/mschart/dev/reference/chart_fill_ggplot2.md)
  : Apply ggplot2 color scale
- [`theme_ggplot2()`](https://ardata-fr.github.io/mschart/dev/reference/theme_ggplot2.md)
  : Apply ggplot2 theme

## Global visual settings

- [`set_theme()`](https://ardata-fr.github.io/mschart/dev/reference/set_theme.md)
  [`mschart_theme()`](https://ardata-fr.github.io/mschart/dev/reference/set_theme.md)
  [`chart_theme()`](https://ardata-fr.github.io/mschart/dev/reference/set_theme.md)
  : Set chart theme

## Send to Microsoft Documents

- [`print(`*`<ms_chart>`*`)`](https://ardata-fr.github.io/mschart/dev/reference/print.ms_chart.md)
...
- [`browser_data`](https://ardata-fr.github.io/mschart/dev/reference/browser_data.md)
  : Dummy dataset for barchart
- [`browser_ts`](https://ardata-fr.github.io/mschart/dev/reference/browser_ts.md)
  : Dummy dataset for time series charts
- [`us_indus_prod`](https://ardata-fr.github.io/mschart/dev/reference/us_indus_prod.md)
